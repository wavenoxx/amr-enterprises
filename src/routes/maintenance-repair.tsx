...
export const Route = createFileRoute("/maintenance-repair")({
  head: () =>
    buildMetaTags({
      title: `Care, Maintenance & Retensioning Protocol — ${BRAND_CONFIG.name}`,
      description:
        `Architectural care instructions and maintenance guidelines for ${BRAND_CONFIG.name} invisible grills, safety nets, and bird deterrent systems.`,
      ...
      jsonLd: {
        ...
        description:
          `Official care guidelines and maintenance schedule for ${BRAND_CONFIG.name} architectural safety installations.`,
        publisher: {
          "@type": "Organization",
      ...
      <main className="max-w-5xl mx-auto px-6 md:px-12 py-16 md:py-24 space-y-20">
        ...
        <article>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-xs text-[#44403C] font-light">
            <div className="border border-[#1C1917]/10 p-6 bg-white shadow-sm">
              <span className="font-medium text-[#1C1917] block mb-1 text-[#F37021]">Tension Recalibration</span>
              <p className="text-[#78716C]">
            ...
            <div className="border border-[#1C1917]/10 p-6 bg-white shadow-sm">
              <span className="font-medium text-[#1C1917] block mb-1 text-[#F37021]">Anchor Inspection</span>
              <p className="text-[#78716C]">
