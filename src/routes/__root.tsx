...
const organizationSchema = {
  ...
  logo: "https://amrenterprises.com/images/brand/amr-full-white.png",
  image: "https://amrenterprises.com/images/homepage/banner-1.jpg",
  description:
    "Bespoke architectural safety solutions: invisible grills, safety netting, and bird protection across Telangana & Andhra Pradesh.",
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://amrenterprises.com" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "canonical", href: "https://amrenterprises.com/" },
